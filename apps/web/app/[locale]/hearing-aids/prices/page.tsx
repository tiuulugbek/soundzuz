...
import { getFeatureHub, priceAscSort } from "../../../../lib/catalog-hubs";
import { HubPage } from "../../../../components/catalog/hub-page";
import "../catalog.css";
import "../hub.css";

const HUB = "prices" as const;
...
export default async function Page({ params }: PageParams) {
  ...
  if (!hub) notFound();
  return <HubPage locale={locale} path={PATH} content={hub.content} match={hub.match} sort={priceAscSort} />;
}
