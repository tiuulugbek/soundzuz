...
export default function HomePage() {
  return (
    <main>
      <header className="site-header"><a className="logo" href="#"><span>S</span>Soundz</a><nav><a href="#hearing">Eshitish moslamalari</a><a href="#iem">Custom IEM</a><a href="#services">Xizmatlar</a><a href="#contact">Aloqa</a></nav><a className="header-cta" href="#contact">Qabulga yozilish</a></header>
      <section className="hero">
        <div className="hero-copy"><p className="eyebrow">ESHITISH SALOMATLIGI MARKAZI</p><h1>Yaqinlaringiz ovozini yana aniq eshiting.</h1><p className="lead">Eshitishni professional tekshirtiring, mutaxassis bilan mos qurilmani tanlang va filialda individual sozlatib oling.</p><div className="hero-actions"><a className="primary" href="#contact">Eshitishni tekshirtirish</a><a className="secondary" href="#hearing">Moslamalarni ko‘rish</a></div><div className="trust-row"><span>✓ Professional audiometriya</span><span>✓ Individual sozlash</span><span>✓ Keyingi servis</span></div></div>
