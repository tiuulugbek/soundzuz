...
export class AdminAppointmentsController {
  ...
  list(
    ...
    const parsedStatus = status ? appointmentStatusSchema.safeParse(status) : undefined;
    return this.appointmentsService.listAdmin({
  ...
  updateStatus(
    ...
    return this.appointmentsService.updateStatus(id, input, request.user.sub, {
